...
public class ThirdActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, TextWatcher {

    public static final String TAG = "ThirdActivity";
    public static final int REQUEST_PERMISSION_PHONE_CALL = 1;
    protected static final String KEY_TEL_NUM = "com.example.inclassinputcontrolspickers.tel_number";
    protected static final String KEY_TEL_TYPE = "com.example.inclassinputcontrolspickers.tel_type";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = findViewById(R.id.edit_text_third);
