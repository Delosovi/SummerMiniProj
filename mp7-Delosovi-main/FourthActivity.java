...
public class FourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        telNum = intent.getStringExtra(ThirdActivity.KEY_TEL_NUM);
        telType = intent.getStringExtra(ThirdActivity.KEY_TEL_TYPE);

        textView = findViewById(R.id.text_2nd_display_number);
        textView.setText(telNum);
        editTextMessage = findViewById(R.id.edit_text_fourth);
